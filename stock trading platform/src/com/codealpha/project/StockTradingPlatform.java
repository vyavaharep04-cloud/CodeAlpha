...
/**
 * Custom modern flat button that overrides OS styling.
 */
class FlatButton extends JButton {
    ...
    public FlatButton(String text, Color background) {
        ...
        // Disable Windows native overlays
...
public class StockTradingPlatform extends JFrame {
    ...
    private JPanel buildTradePanel() {
        ...
        // Operation Execution Buttons (Upgraded to FlatButton to avoid rendering bugs)
        JPanel actionPanel = new JPanel(new GridLayout(1, 2, 15, 0));
        actionPanel.setBackground(new Color(30, 41, 59));

        FlatButton buyBtn = new FlatButton("EXECUTE BUY ORDER", new Color(16, 185, 129)); // Dynamic Emerald Green
        buyBtn.addActionListener(e -> executeTransaction(true));

        FlatButton sellBtn = new FlatButton("EXECUTE SELL ORDER", new Color(239, 68, 68)); // Dynamic Crimson Red
